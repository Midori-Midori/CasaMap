// ============================================================
//  CasaMap · script-googlemaps.js
//  Versión para Antigravity / servidor HTTP real
//
//  INSTRUCCIONES DE ACTIVACIÓN:
//  1. En index.html reemplaza el bloque <div id="mock-map">
//     completo por: <div id="map"></div>
//  2. Renombra este archivo a script.js (reemplaza el actual)
//  3. Agrega el loader de Google Maps antes de </body>:
//
...
//     e.set("libraries",[...r]+"");for(k in g)e.set(
//     k.replace(/[A-Z]/g,t=>"_"+t[0].toLowerCase()),g[k]);
//     e.set("callback",c+".maps."+q);
//     a.src=`https://maps.${c}apis.com/maps/api/js?`+e;
//     d[q]=f;a.onerror=()=>h=n(Error(p+" could not load."));
//     a.nonce=m.querySelector("script[nonce]")?.nonce||"";
//     m.head.append(a)}));d[l]?console.warn(p+
//     " only loads once. Ignoring:",g):d[l]=(f,...n)=>
//     r.add(f)&&u().then(()=>d[l](f,...n))})
//     ({key: "AIzaSyAVG3w8SB--KX1DNB0ELmuj1aDl1MFiogA",
//       v: "weekly", libraries: "places", callback: "initMap"});
//     </script>
//
// ============================================================
...
async function renderGoogleMarkers() {
  ...
  Object.values(gMarkers).forEach(m => m.map = null);
